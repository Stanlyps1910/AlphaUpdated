    ...
    return (
        ...
        >
            ...
            <div className={`flex-1 transition-all duration-500 flex flex-col min-w-0 ${!isFocusMode ? "lg:ml-[280px]" : "ml-0"}`}>
                <div className={`sticky top-0 z-40 transition-all duration-500 pt-6 px-4 md:px-10 pb-4 flex flex-wrap items-center justify-between gap-4 bg-white/70 backdrop-blur-[20px] border-b border-[#e6e3df]/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] ${isFocusMode || !isVisible ? "opacity-0 -translate-y-full pointer-events-none" : "opacity-100 translate-y-0"}`}>
