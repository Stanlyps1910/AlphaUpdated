            ...
            >
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                    ...
                    <div className="pt-4 border-t border-white/40 space-y-5">
                        {/* New Section for Client Portal Account */}
                        <div className="bg-white/30 rounded-[20px] p-5 border border-white/40 space-y-4">
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="w-4 h-4 rounded text-[#2d2d2d] focus:ring-[#D9CDEB]"
                                    checked={formData.createAccount}
                                    onChange={(e) => setFormData({ ...formData, createAccount: e.target.checked })}
                                />
                                <span className="text-[10px] uppercase font-bold tracking-[0.15em] text-[#2d2d2d]">Create Client Portal Account</span>
                            </label>

                            {formData.createAccount && (
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 border-t border-white/20">
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] uppercase font-bold tracking-widest text-[#9a9a9a] ml-1">First Name</label>
                                        <input required={formData.createAccount} type="text" className="w-full bg-white/50 border border-white/60 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-[#D9CDEB]" value={formData.firstName} onChange={e => setFormData({ ...formData, firstName: e.target.value })} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] uppercase font-bold tracking-widest text-[#9a9a9a] ml-1">Last Name</label>
                                        <input required={formData.createAccount} type="text" className="w-full bg-white/50 border border-white/60 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-[#D9CDEB]" value={formData.lastName} onChange={e => setFormData({ ...formData, lastName: e.target.value })} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] uppercase font-bold tracking-widest text-[#9a9a9a] ml-1">Account Email</label>
                                        <input type="email" placeholder="Defaults to Lead Email" className="w-full bg-white/50 border border-white/60 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-[#D9CDEB]" value={formData.accountEmail} onChange={e => setFormData({ ...formData, accountEmail: e.target.value })} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] uppercase font-bold tracking-widest text-[#9a9a9a] ml-1">Password</label>
                                        <input required={formData.createAccount} type="password" placeholder="Min 6 chars" className="w-full bg-white/50 border border-white/60 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-[#D9CDEB]" value={formData.password} onChange={e => setFormData({ ...formData, password: e.target.value })} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] uppercase font-bold tracking-widest text-[#9a9a9a] ml-1">Cloud Link</label>
                                        <input type="url" placeholder="Optional link" className="w-full bg-white/50 border border-white/60 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-[#D9CDEB]" value={formData.cloudLink} onChange={e => setFormData({ ...formData, cloudLink: e.target.value })} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] uppercase font-bold tracking-widest text-[#9a9a9a] ml-1">Cloud Password</label>
                                        <input type="text" placeholder="Optional" className="w-full bg-white/50 border border-white/60 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-[#D9CDEB]" value={formData.cloudPassword} onChange={e => setFormData({ ...formData, cloudPassword: e.target.value })} />
                                    </div>
                                </div>
                            )}
                        </div>
