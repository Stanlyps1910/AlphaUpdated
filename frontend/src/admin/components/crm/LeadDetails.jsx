...
import { X, Mail, Phone, Calendar, Tag, User, Users, Plus, CheckCircle2, MoreVertical, Trash2, Edit2, MapPin, Clock, Save, Loader2, Cloud, Lock, FolderOpen } from "lucide-react";
                                ...
                                <div className="space-y-2">
                                    ...
                                    {isEditing ? (
                                        <input
                                            ...
                                            className="bg-white/60 border border-white/80 rounded-xl px-3 py-2 w-full text-xs text-[#2d2d2d] focus:outline-none focus:border-[#D9CDEB] shadow-inner"
                                        />
                                    ) : (
                                        <div className="text-xs text-[#2d2d2d] font-bold truncate">
                                            {lead.cloudLink ? <a href={lead.cloudLink} target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">{lead.cloudLink}</a> : "Not Set"}
                                        </div>
                                    )}
                                </div>
                                <div className="space-y-2">
                                    <label className="flex items-center gap-2 text-[10px] uppercase font-bold tracking-[0.15em] text-[#9a9a9a] ml-1">
                                        <Lock size={12} className="opacity-60" /> Vault Password
                                    </label>
                                    {isEditing ? (
                                        <input
                                            type="text"
                                        ...
                                        <div className="text-xs text-[#2d2d2d] font-bold font-mono">
                                            {lead.cloudPassword || "Not Set"}
                                        </div>
                                    )}
                                </div>
                                <div className="space-y-2 col-span-full">
                                    <label className="flex items-center gap-2 text-[10px] uppercase font-bold tracking-[0.15em] text-[#9a9a9a] ml-1">
                                        <Tag size={12} className="opacity-60" /> Gallery Search Tag
                                    </label>
                                    {isEditing ? (
                                        <input
                                            type="text"
                                            placeholder="e.g. MEGHNAARJUN"
