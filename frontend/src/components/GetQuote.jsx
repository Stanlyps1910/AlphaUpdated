...
const GetQuote = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const url = `https://wa.me/919110603953?text=${encodedText}`;

        window.open(url, '_blank');
    };

    return (
        <div className="font-sans text-[#1C1C1C] bg-[#F7F5F2] min-h-screen selection:bg-black selection:text-white pt-48">
